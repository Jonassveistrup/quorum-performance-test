...
do
	...
	#sshpass -p "Deloitte1234" scp -r "install.sh" "admin_scalability@${node_ip}:/home/admin_scalability/"
	#sshpass -p "Deloitte1234" scp -r "install_screen.sh" "admin_scalability@${node_ip}:/home/admin_scalability/"
	sshpass -p "Deloitte1234" ssh -t "admin_scalability@${node_ip}" "./install_screen.sh"
done
